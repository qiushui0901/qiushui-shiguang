...
import com.quanshiguang.shiguang.comment.biz.model.bo.CommentHeatBO;
import com.quanshiguang.shiguang.comment.biz.util.HeatCalculator;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "shiguang_group_" + MQConstants.TOPIC_COMMENT_HEAT_UPDATE, // Group 组
