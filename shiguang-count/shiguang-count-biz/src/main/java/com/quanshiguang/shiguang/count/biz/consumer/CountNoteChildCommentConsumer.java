...
import com.quanshiguang.shiguang.count.biz.domain.mapper.CommentDOMapper;
import com.quanshiguang.shiguang.count.biz.enums.CommentLevelEnum;
import com.quanshiguang.shiguang.count.biz.model.dto.CountPublishCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "shiguang_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
