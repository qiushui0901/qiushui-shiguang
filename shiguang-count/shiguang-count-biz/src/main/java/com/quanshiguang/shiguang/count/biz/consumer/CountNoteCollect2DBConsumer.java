...
import com.quanshiguang.shiguang.count.biz.domain.mapper.NoteCountDOMapper;
import com.quanshiguang.shiguang.count.biz.domain.mapper.UserCountDOMapper;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "shiguang_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT_2_DB, // Group 组
