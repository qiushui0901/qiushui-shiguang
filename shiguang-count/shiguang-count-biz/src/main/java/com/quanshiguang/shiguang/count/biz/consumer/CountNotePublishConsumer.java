...
import com.quanshiguang.shiguang.count.biz.model.dto.NoteOperateMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "shiguang_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
