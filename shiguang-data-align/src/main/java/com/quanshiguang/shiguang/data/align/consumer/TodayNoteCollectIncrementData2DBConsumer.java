package com.quanshiguang.shiguang.data.align.consumer;

import com.quanshiguang.framework.common.util.JsonUtils;
import com.quanshiguang.shiguang.data.align.constant.MQConstants;
import com.quanshiguang.shiguang.data.align.constant.RedisKeyConstants;
import com.quanshiguang.shiguang.data.align.constant.TableConstants;
import com.quanshiguang.shiguang.data.align.domain.mapper.InsertMapper;
import com.quanshiguang.shiguang.data.align.model.dto.CollectUnCollectNoteMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "shiguang_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
