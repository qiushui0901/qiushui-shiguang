package com.quanshiguang.shiguang.gateway.auth;
        ...
        return new SaReactorFilter()
                ...
                .setAuth(obj -> {
                    ...
                    SaRouter.match("/**") // 拦截所有路由
                            ...
                            .notMatch("/search/note/trending") // 排除热度排行（未登录也可访问）
                            .notMatch("/search/note/suggest") // 排除搜索建议（未登录也可访问）
                            .notMatch("/agent/search/summary") // 排除AI搜索总结（未登录也可访问）
