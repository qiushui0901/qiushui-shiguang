package com.quanshiguang.shiguang.user.relation.biz.consumer;
...
import com.quanshiguang.shiguang.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.quanshiguang.shiguang.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "shiguang_group_" + MQConstants.TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
